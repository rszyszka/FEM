...
public class LokalElement2P {
    ...
    private final LokalNode[] ND = { //punkty calkowania gaussa 2P
...
//    private final LokalNode[] ND = { //punkty calkowania gaussa 3P
//        new LokalNode(-1.0 / Math.sqrt(3.0), -1.0 / Math.sqrt(3.0)),
//        new LokalNode(1.0 / Math.sqrt(3.0), -1.0 / Math.sqrt(3.0)),
//        new LokalNode(1.0 / Math.sqrt(3.0), 1.0 / Math.sqrt(3.0)),
//        new LokalNode(-1.0 / Math.sqrt(3.0), 1.0 / Math.sqrt(3.0))
//    };
    ...
    private LokalElement2P() {
        ...
        for (int i = 0; i < 4; i++) { //wypelniamy macierze funkcji ksztaltu
            N[i][0] = N1(ND[i].getKsi(), ND[i].getEta());
            N[i][1] = N2(ND[i].getKsi(), ND[i].getEta());
            N[i][2] = N3(ND[i].getKsi(), ND[i].getEta());
            N[i][3] = N4(ND[i].getKsi(), ND[i].getEta());

            dN_dKsi[i][0] = dN1dKsi(ND[i].getKsi(), ND[i].getEta());
            dN_dKsi[i][1] = dN2dKsi(ND[i].getKsi(), ND[i].getEta());
            dN_dKsi[i][2] = dN3dKsi(ND[i].getKsi(), ND[i].getEta());
            dN_dKsi[i][3] = dN4dKsi(ND[i].getKsi(), ND[i].getEta());

            dN_dEta[i][0] = dN1dEta(ND[i].getKsi(), ND[i].getEta());
            dN_dEta[i][1] = dN2dEta(ND[i].getKsi(), ND[i].getEta());
            dN_dEta[i][2] = dN3dEta(ND[i].getKsi(), ND[i].getEta());
            dN_dEta[i][3] = dN4dEta(ND[i].getKsi(), ND[i].getEta());
